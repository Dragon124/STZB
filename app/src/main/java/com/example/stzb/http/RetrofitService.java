...
public interface RetrofitService {
    @GET("https://stzb.cbg.163.com/cgi/api/query?view_loc=search_cond&search_type=role&price_max=30000&order_by=")
    Call<AccountBeans> getAccounts(@Query("_") String time, @Query("page") String page, @Query("pageSessionId") String pageSessionId);
